...
```javascript
import isndarrayLikeWithDataType from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-ndarray-like-with-data-type@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-ndarray-like-with-data-type/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/assert-is-ndarray-like-with-data-type/actions/workflows/test.yml?query=branch:v0.1.0
